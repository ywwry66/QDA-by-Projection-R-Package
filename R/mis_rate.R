...
##' @param sigma0 An intertible matrix representing the covariance matrix of class 0
##' @param sigma1 An invertible matrix representing the covariance matrix of class 1
##' @return The return value is the classification error/misclassification rate of the two-class heteroscedastic Gaussian model, whose class means are 'mu0' and 'mu1' and class covariance matrices are 'sigma0' and 'sigma1', after 1-D projection onto the direction 'a'.
##' @export
